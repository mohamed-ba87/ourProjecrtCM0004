...
if(isset($_POST['userRej'])){
    ...
    if(empty($error)){
       ...
       $put= "INSERT INTO login (username,email,password) VALUES ('$username','$email','$password')";
        mysqli_query($db,$put);
        ...
        $put2= "SELECT id_user FROM login WHERE username=$username";
        ...
        $put= "INSERT INTO user(user_id,firstname,lastname,address1,address2,city,postcode) VALUES ('$log_id','$f_name','$L_name','$add_1','$add_2','$city','$postcode')";
        echo " we done it 2";
